    ...
    Base.mix(PopupUpload, Component, {
            ...
            '<div>',
              '<div class="form-group">',
                ...
                '</div>',
                  ...
                  '<div class="form-group"><label class="col-sm-2 control-label">摘要</label><div class="col-sm-10"><input class="js-summary form-control" type="text"></div></div>',
        ...
        listeners: [{
            ...
            handler: function () {
                ...
                var sSummary = $.trim(oEl.find('input.js-summary').val());
                if (!sTitle) {
                    return alert('标题不能为空');
                }
                if (!sLink) {
                ...
                $.ajax({
                    url: '/user/addNews/',
                    method: 'post',
                    data: {image: that.image, title: sTitle, link: sLink, summary: sSummary},
                    dataType: 'json'

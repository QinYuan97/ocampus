    ...
    public String reg(Model model, @RequestParam("username") String username,
        ...
        try{
            ...
            if(map.containsKey("ticket")){
                ...
                eventProducer.fireEvent(new EventModel(EventType.LOGIN).setActorId((int) map.get("userId")).setEntityOwnerId((int)map.get("userId"))
                        .setExt("username", "张三").setExt("to", email));
